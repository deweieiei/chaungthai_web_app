...
// ============================================================
//  Routes — เว็บทางการ (สาธารณะ ไม่ต้องล็อกอิน, เน้น SEO)
//  หน้าแรกเล่าว่าแพลตฟอร์มคืออะไร ใช้ยังไง + ปุ่มเข้าสู่ระบบมุมขวาบน
//  *** ไม่เด้งเข้า /home อัตโนมัติแม้ล็อกอินอยู่ ***
// ============================================================
app.get('/', (req, res) =>
  page(req, res, 'site/index', {
    title: 'หาคนเก่งใกล้ตัว จ้างงานง่าย เห็นบนแผนที่',
    canonical: '/',
  })
);
app.get('/how-it-works', (req, res) =>
  page(req, res, 'site/how-it-works', {
    title: 'วิธีใช้งาน',
    metaDesc: 'วิธีใช้ช่างไทย ทั้งฝั่งคนจ้างและฝั่งช่าง — ค้นบนแผนที่ แชท จ้าง ปิดงาน ให้ดาว',
    canonical: '/how-it-works',
  })
);
app.get('/about', (req, res) =>
  page(req, res, 'site/about', {
    title: 'เกี่ยวกับเรา',
    metaDesc: 'ช่างไทยคือแพลตฟอร์มจับคู่คนมีฝีมือกับคนที่ต้องการจ้าง เปิดใช้งานทั่วประเทศ',
    canonical: '/about',
  })
);
